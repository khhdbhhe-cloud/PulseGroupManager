...
function resolveTarget(
  ...
  // اگر Reply شامل username یا ID است
  // هرگز فرستنده پیام را اشتباهی هدف نکن
  if (
