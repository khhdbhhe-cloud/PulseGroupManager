...
// =====================================
//
// این قسمت را قبل از دکمه‌های پنل
// ثبت می‌کنیم تا کنترل‌های جدید
// حفاظت گروه بتوانند دکمه‌های مربوط
// به خودشان را مدیریت کنند.
//
// =====================================

registerGroupProtection(bot);
...
// =====================================
// ثبت سیستم قفل‌های رسانه‌ای
// =====================================

registerMediaLocks(bot);
